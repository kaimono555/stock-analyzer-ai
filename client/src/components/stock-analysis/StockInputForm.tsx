      ...
      <div>
        ...
        <div className="mt-1 flex rounded-md shadow-sm">
          <input
            ...
            className="flex-1 block w-full rounded-none rounded-l-md bg-gray-700 border-gray-600 focus:ring-sky-500 focus:border-sky-500 sm:text-sm p-3 placeholder-gray-500 text-gray-100 border focus:outline-none focus:ring-2 transition-colors duration-150"
